          ...
          <div class="row">
            <div class="col-lg-4 col-md-4">
              <?php if( get_theme_mod( 'vw_gardening_landscaping_phone_number') != '') { ?>
                <i class="<?php echo esc_attr(get_theme_mod('vw_gardening_landscaping_phone_icon','fas fa-phone')); ?>"></i><span><a href="tel:<?php echo esc_url( get_theme_mod('vw_gardening_landscaping_phone_number','') ); ?>"><?php echo esc_html(get_theme_mod('vw_gardening_landscaping_phone_number',''));?></a></span>
              <?php }?>
            </div>
            <div class="col-lg-8 col-md-8">
              <?php if( get_theme_mod( 'vw_gardening_landscaping_email_address') != '') { ?>
                <i class="<?php echo esc_attr(get_theme_mod('vw_gardening_landscaping_email_icon','fas fa-envelope-open')); ?>"></i><span><a href="mailto:<?php echo esc_html(get_theme_mod('vw_gardening_landscaping_email_address',''));?>"><?php echo esc_html(get_theme_mod('vw_gardening_landscaping_email_address',''));?></a></span>
              <?php }?>
            </div>
          </div>
        </div>
